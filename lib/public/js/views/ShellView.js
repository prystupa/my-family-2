...
define(function (require, exports, module) {
    ...
    function watchHeartbeat(view) {
        var $alerts = view.$('.app-alerts');
        ...
        function resetHeartbeatMessage() {
            $alerts.find('.heartbeat').trigger('jGrowl.close').remove();
        }

        function heartbeatMessage(message, options) {
            resetHeartbeatMessage();
            $alerts.jGrowl(message, _.extend({header: 'Heartbeat', group: 'heartbeat'}, options));
        }
